...
Route::group(['middleware' => ['checkBackend', 'auth', 'activity'], 'prefix' => 'dashboard'], function () {
    ...
    Route::get('school/index', 'Module\SchoolController@index')->name('school.index');
    Route::get('school/create', 'Module\SchoolController@create')->name('school.create');
    Route::get('school/edit/{id}', 'Module\SchoolController@edit')->name('school.edit');
    Route::get('school/destroy/{id}', 'Module\SchoolController@destroy')->name('school.destroy');
    Route::post('school/store', 'Module\SchoolController@store')->name('school.store')->middleware('demo');
    Route::post('school/update', 'Module\SchoolController@update')->name('school.update')->middleware('demo');
    ...
    Route::get('student/{id}', 'Module\StudentController@edit')->name('students.edit');
    Route::post('student/update', 'Module\StudentController@update')->name('students.update');
