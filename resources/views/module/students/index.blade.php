                    ...
                    <div class="col">
                        <form method="get" action="">
                            <div class="input-group">
                                <div class="input-group">
                                    <label for="student" style="margin-right: 10px;" >@translate(Is student ?) </label>
                                    <input name="student" type="checkbox" class="js-switch-success"
                                           {{Request::get('student') == 'on' ? 'checked' : ''}}
                                           id="student" value="on">
                                </div>
