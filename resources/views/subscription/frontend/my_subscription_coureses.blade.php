                                                                    ...
                                                                    <div class="skillbar-box mt-1">
                                                                        <div class="skillbar">
                                                                            <div class="skillbar-bar skillbar-bar-1"
                                                                                 style="width: {{\App\Http\Controllers\FrontendController::seenCourse($item->id,$item->course->id) }}%;"></div>
                                                                        </div> <!-- End Skill Bar -->
                                                                    </div>
                                                                    <div
                                                                        class="skill-bar-percent">{{\App\Http\Controllers\FrontendController::seenCourse($item->id,$item->course->id)}}
                                                                        %
                                                                    </div>
                                                                </div>
