                            ...
                            <div class="card mb-4 box-shadow shadow border-success text-center">
                                <div class="card-header bg-success">
                                    @foreach (json_decode($package->description) as $item)
                                        <h4 class="my-0 font-weight-normal text-light">{{ $item }}</h4>
                                    @endforeach
                                </div>
                                <div class="card-body">
                                    ...
                                    <h5>
                                        <a href="{{ route('subscription.package.courses' , [$package->duration, $package->id]) }}">
                                            {{ App\SubscriptionCourse::where('subscription_duration','LIKE','%'.$package->duration.'%')->with('subscription')->where('subscription_id', $package->id)->count() }} Courses
                                        </a>
                                    </h5>
