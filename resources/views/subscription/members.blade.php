                ...
                <table class="table foo-filtering-table text-center">
                    ...
                    @forelse ($members as $member)
                        ...
                        <tr>
                            ...
                            <td>
                                @php        
                                    $subs = App\SubscriptionEnrollment::where('subscription_package', $member->subscription_package)->where('end_at',  '>' , Carbon\Carbon::now())->where('user_id', $member->user_id)->count();
                                @endphp
