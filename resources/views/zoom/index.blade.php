...
<div class="box text-black">
  	<div class="box-header with-border">
  		<div class="box-title h2">
			@translate(All Meetings) ({{ App\Meeting::where('user_id', \Illuminate\Support\Facades\Auth::id())->count() }})
  		</div>
  				...
  				@foreach($meetings as $key => $meeting)
					<tr class="text-black background-white">
						...
						<td>
							...
							<p><b>Start Time:</b>{{ isset($meeting['start_time']) ? formateZoomDateView($meeting) : "" }} </p>
						...
						<td>
							...
							@if(\App\Meeting::where('meeting_id', $meeting['id'])->exists())
