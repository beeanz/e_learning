...
{{--				</a>--}}
		...
		<div class="box-body">
			...
			<hr>
			<h3>Start Time :{{ isset($meeting->start_time) ? date('d-m-Y | h:i:s A',strtotime($meeting->start_time)) : (isset($response['start_time']) ? date('d-m-Y | h:i:s A',strtotime($response['start_time'])) : "")}}</h3>
			<hr>
