                            ...
                            <div class="logo-right-button">
                                                ...
                                                <ul class="user-cart d-flex align-items-center ">
                                                    <li class="p-50p">
                                                        <a href="{{route('my.subscription')}}"
                                                           class="btn btn-success text-white my-course-btn">@translate(My Subscriptions)</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                                            ...
                                                            @if (Auth::user()->user_type != "Admin")
                                                                ...
                                                                <div class="mess__body">
                                                                    <ul class="list-items">
                                                                        ...
                                                                        <li class="mb-0">
                                                                            <a href="{{route('my.subscription')}}" class="d-block">
                                                                                <i class="la la-file-video-o"></i> @translate(My Subscriptions)
                                                                            </a>
                                                                        </li>
                                ...
                                <div class="menu-toggler d-flex align-items-center">
                                        <div class="side-menu-open">
                                            <i class="la la-bars" onclick="openMenuNav()"></i>
                                            <div id="mySidebarMenu" class="cart-sidebar">
                                                <a href="javascript:void(0)" class="closebtn"
                                                   onclick="closeMenuNav()">close</a>
                                                <a href="javascript:void(0)" class="arrow-btn" onclick="closeMenuNav()"> <i
                                                            class="fa fa-angle-right"></i> </a>
                                                <div class="text-center">
                                    ...
                                    <div id="avatar" class="user-menu-open ml-2">
                                        @if (Auth::user()->user_type === 'Student')
                                            <a href="{{ route('student.profile') }}"
                            ...
                            <div class="logo-right-button">
                                <ul id="custom_toggle_bar" class="d-flex">
                                    {{-- <li class="pr-2"><a href="{{route('instructor.register')}}"
                                                        class="theme-btn instructor-btn">@translate(Teach on Yamato)</a></li> --}}
