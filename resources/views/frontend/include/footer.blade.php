...
{{--                                        <option value="{{$language->code}}"  {{ session('locale') == $language->code ? 'selected' : null }} @if(!session('locale') && env('DEFAULT_LANGUAGE') == $language->code) selected="selected" @endif>{{$language->name}}</option>--}}
{{--                                    @endforeach--}}
{{--                                </select>--}}
{{--                            </form>--}}
                        </div>
