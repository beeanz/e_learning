...
class CouponController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            [
                'code.unique' => translate('Coupon Code must be unique'),
            ]);

        $coupon = new Coupon();
        $coupon->code = $request->code;
        $coupon->rate = $request->rate;
        $coupon->start_day = Carbon::createFromFormat('d/m/Y', $request->start_day);
        $coupon->end_day = Carbon::createFromFormat('d/m/Y', $request->end_day);
    ...
    public function update(Request $request, $id)
    {
        ...
        $coupon_update->start_day = Carbon::createFromFormat('d/m/Y', $request->start_day);
        $coupon_update->end_day = Carbon::createFromFormat('d/m/Y', $request->end_day);
